                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <Select 
                      ...
                      onValueChange={(value) => handleSystemPreferenceChange('fiscalYearStart', value)}
                    >
                      <SelectTrigger>
                  ...
                  <div>
                    ...
                    <Select 
                      ...
                      onValueChange={(value) => handleSystemPreferenceChange('backupFrequency', value)}
                    >
                      <SelectTrigger>
                  ...
                  <div>
                    ...
                    <Select 
                      ...
                      onValueChange={(value) => handleSystemPreferenceChange('sessionTimeout', parseInt(value))}
                    >
                      <SelectTrigger>
                      ...
                      {['gantt', 'kanban', 'reports', 'payroll', 'leaves', 'performance', 'accounting', 'billing', 'requests', 'approvals', 'vendors'].map((feature) => (
                        <div key={feature} className="flex items-center space-x-2">
                          <Switch
                            ...
                            onCheckedChange={(enabled) => handleModuleFeatureToggle(moduleName, feature, enabled)}
                            size="sm"
                          />
                          <Label 
